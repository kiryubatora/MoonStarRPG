    ...
    public class RuntimeVariableInjector<TVariable> : MonoBehaviour where TVariable : ScriptableVariableBase
    {
        ...
        private void Awake()
        {
            ...
            foreach (var wrapper in _runtimeVariables)
            {
                ...
                {
                    var deepCopy = SoapUtils.CreateCopy(injectedVariable.VariableTemplate);
                ...
                {
                    var runtimeVariable =
                        SoapUtils.CreateRuntimeInstance<TVariable>($"{gameObject.name}_{injectedVariable.Id}");
            ...
            {
                SoapInjectionUtils.InjectInChildren(
                    gameObject,
